...
Common_State_Visible(Num_var).Triple_DO_cis= rmfield(Common_State_Visible(Num_var).Triple_DO_cis,'Visibility_Unambiguity_Score');
Common_State_Visible(Num_var).Triple_DO_cis.Unambiguity_Score = Unambiguity_Score;
Common_State_Visible(Num_var).Triple_DO_cis.Mean_Common_State = Mean_Common_State;
Common_State_Visible(Num_var).Triple_DO_cis.Num_State_Members = Num_State_Members;
Common_State_Visible(Num_var).Triple_DO_cis.index = index;
Common_State_Visible(Num_var).Triple_DO_cis.Mean_Common_in_Visible = Mean_Common_in_Visible;
Common_State_Visible(Num_var).Triple_DO_cis.Sum_P_Detection_in_Visibles = Sum_P_Detection_in_Visibles;
